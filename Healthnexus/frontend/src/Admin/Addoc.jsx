...
function Addoc() {
  ...
  <div className="row my-4">
    <div className="col-md-8 mx-auto p-5">
      <form onSubmit={docreg} className="shadow-lg rounded-4 p-2">
            <h4 className='text-center pt-2'>Add Doctor</h4>
            <br />
            ...
            <input type="tel" onChange={(e)=>setMobile(e.target.value)} value={mobile} className="form-control rounded-pill px-4" />
            <br />
            ...
            <input type="text" onChange={(e)=>setQua(e.target.value)} value={qua} className="form-control rounded-pill px-4" />
            <br />
            <label htmlFor="exp">Experience</label>
            <input type="text" onChange={(e)=>setExp(e.target.value)} value={exp} className="form-control rounded-pill px-4" />
            <br />
            <label htmlFor="spe">Speciality:</label>
            <input type="text" onChange={(e)=>setSpe(e.target.value)} value={spe} className="form-control rounded-pill px-4" />
            <br />
            ...
            <textarea type="text" onChange={(e)=>setAddress(e.target.value)} value={address} className="form-control rounded-pill px-4" ></textarea>
              <br />
              <br />
            <input type="submit" value="Add Doctor" className="btn btn-primary form-control rounded-pill px-4" />
      </form>
    </div>
  </div>
